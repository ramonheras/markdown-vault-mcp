...
| **MCP Apps: domain** | `mcp_server.py:_compute_claude_app_domain()` | `mcp_server.py:_compute_claude_app_domain()` | Derives Claude app domain from `BASE_URL`; overridden by `APP_DOMAIN` env var |
